...
import 'package:dicecash/models/user.dart';
...
class _CreateProfileState extends State<CreateProfile> {
  ...
  final List<String> _dropdownValues = ['Just a Kid', 'I go to school/college', 'I am a professional', 'I am a home maker/house wife', 'I am retired', 'Other'];
  String _selectedValue = "Just a Kid";
  final List<String> _dropdownValues2 = ['English', 'Hindi'];
  final List<List<String>> courseRecomm = [];
  String _selectedValue2 = "English";
  @override
  void initState() {
    super.initState();
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: InputDecorator(
                                  decoration: InputDecoration(
                                    labelText: Languages.of(context)?.labelSelectLanguage,
                                    // 'Select Language 🌎',
                                    enabledBorder: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(15),
                                      borderSide: BorderSide(
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    items: _dropdownValues2.map((String value) {
                            ...
                            InkWell(
                              onTap: () async {
                                await UserDatabaseHelper().updateUserData2(
                                    nameController.text, ageController.text, _selectedValue);
