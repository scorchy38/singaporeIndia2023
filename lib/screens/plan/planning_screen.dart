...
import 'package:dicecash/screens/plan/bannners.dart';
...
import 'emergency_planning_screen.dart';

class PlanningScreeen extends StatefulWidget {
  const PlanningScreeen({key});
...
class _PlanningScreeenState extends State<PlanningScreeen> {
  ...
  InkWell planningCard(Map<dynamic, dynamic> map, textName, targetFunds,
