...
// The size of the icon showen for Social Actions
  static const double ActionIconSize = 34.0;

// The size of the share social icon
  static const double ShareActionIconSize = 24.0;
// The size of the profile image in the follow Action
  static const double ProfileImageSize = 49.0;

// The size of the plus icon under the profile image in follow action
  static const double PlusIconSize = 19.0;
  ...
  Widget _getSocialAction({required String title, required IconData icon, bool isShare = false}) {
    return InkWell(
      onTap: (){
        SocialShare.shareOptions('See this video on SheFi');
      },
      child: Container(
          margin: EdgeInsets.only(top: 15.0, bottom: 50),
          width: 60.0,
          height: 62.0,
